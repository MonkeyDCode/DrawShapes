...
public class ZigzagStroke implements Stroke {
    ...
    public ZigzagStroke()
    {
        this(new BasicStroke(), 3, 3);
    }
    
    public ZigzagStroke(float amplitude,float wavelenght)
    {
        this(new BasicStroke(), amplitude, wavelenght);
    }
    
    public ZigzagStroke(float amplitude)
    {
        this(new BasicStroke(amplitude), 3, 3);
    }
